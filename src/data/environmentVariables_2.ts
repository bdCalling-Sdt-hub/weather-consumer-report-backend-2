...
export const NODEMAILER_PORT = process.env.NODEMAILER_PORT as any;
export const NODEMAILER_SECURE_STATUS =
  process.env.NODEMAILER_SECURE_STATUS === 'true' ? true : false;
