...
export const addProductWithReviewController = myControllerHandler(
  async (req, res) => {
    ...
    dataToSave.reviewText = myData.fields.user_opinion[0];
    dataToSave.rating = myData.fields.user_rating[0];
    ...
    await reviewDataModelOfWeatherConsumerReport.create({
      userId: userData.id,
      reviewText: dataToSave.reviewText,
